...
def chartdb(chart_json: str | dict, key=None):
    """Create a new instance of "chartdb".

    Parameters
    ----------
    chart_json: str or dict
        A JSON or Dict with the definition of the chart that represents your BD Diagram.
        Check ChartDB.io for more information.
    key: str or None
